...
with tf.device("/GPU:1"):
    ...
    x_trains.to_csv("./trainsX1DCNNLSTM.csv", mode='w', index=False)
    x_tests.to_csv("./testsX1DCNNLSTM.csv",mode='w', index=False)
    # Sampling
...
with tf.device("/GPU:1"):
    ...
    df_Test.to_csv("./result/1DCNNLSTM_result.csv",mode='w')
    #print("###############################WITH PREDICT")
    #print(df_Test)
